...
from PyQt6.QtWidgets import (
    ...
    QVBoxLayout, QWidget, QProgressBar, QDialog, QComboBox
)
    ...
    def paintEvent(self, _):
        ...
        if self._face_px:
            ...
            p.drawText(QRectF(cx - 80, cy - 14, 160, 28),
                       Qt.AlignmentFlag.AlignCenter, "E.V.O")
...
class LogWidget(QTextEdit):
    ...
    def stream_append(self, text: str, is_new: bool = False, tag: str = "ai"):
        if is_new:
    ...
    def _next(self):
        ...
        elif tl.startswith("jarvis:") or tl.startswith("evo:"): self._tag = "ai"
...
class FileDropZone(QWidget):
    ...
    def _browse(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select a file for EVO", str(Path.home()),
            "All Files (*.*);;"
